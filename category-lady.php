                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li>
                                    <a href="catalog-men.xml">Men <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a href="men-Tshirts.xml">T-shirts</a>
                                        </li>
                                        <li><a href="men-Shirts.xml">Shirts</a>
                                        </li>
                                        <li><a href="men-Pants.xml">Pants</a>
                                        </li>
                                        <li><a href="men-Accessories.xml">Accessories</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="active">
                                    <a href="catalog-lady.xml">Ladies  <span class="badge pull-right">12</span></a>
                                    <ul>
