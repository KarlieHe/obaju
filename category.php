...
<body>
 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <!--
                            change the href of each bottom
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li class="active">
                                    <a href="category-men.html">Men <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a id="TSHIRS" href="men-Tshirts.xml">T-shirts</a>
                                        </li>
                                        <li><a id="SHIRTS" href="men-Shirts.xml">Shirts</a>
                                        </li>
                                        <li><a id="PANTS" href="men-Pants.xml">Pants</a>
                                        </li>
                                        <li><a id="ACCESSORIES" href="men-Accessories.xml">Accessories</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="category-lady.php">Ladies <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a href="ladies.xml">T-shirts</a>
                                        </li>
                                        <li><a href="lady-Shirts.xml">Shirts</a>
                                        </li>
                                        <li><a href="lady-Pants.xml">Pants</a>
                                        </li>
                                        <li><a href="lady-Accessories.xml">Accessories</a>
                                        </li>
                                    </ul>
                                </li>
								<!--
