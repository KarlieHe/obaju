...
_________________________________________________________ -->
                <div class="panel panel-default sidebar-menu">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked category-menu">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="js_method_lady(1)">Ladies <span class="badge pull-right">12</span></a>
                                <ul>
                                    <li><a href="javascript:void(0);" onclick="js_method_lady(2)"> T-shirts</a>
                                    </li>
                                    <li><a href="javascript:void(0);" onclick="js_method_lady(3)">Shirts</a>
                ...
                <div class="panel panel-default sidebar-menu">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Brands <a class="btn btn-xs btn-danger pull-right" href="javascript:void(0);" onclick="reset_check()"><i class="fa fa-times-circle"></i> Clear</a></h3>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form>
                            ...
                            <a class="btn btn-default btn-sm btn-primary" id="apply" onclick="get_brand()"><i class="fa fa-pencil"></i> Apply</a>
                                ...
                                <form class="form-inline">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="products-sort-by">
                                            ...
                                            <select name="sort-by" class="form-control" id="priceSelect" onchange="priceSort()">
                                                <!--
