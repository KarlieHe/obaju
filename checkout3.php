                                    ...
                                    <div class="col-sm-6">
                                        <div class="box payment-method">
											...
											<div class="row">
											  ...
											  <div class="col-sm-10 form-group">
												<input type="text" name="cardnumber" placeholder="Card Number" maxlength="14"  class="form-control">
											  </div>
											  ...
											  <div class="col-sm-4 form-group">
												<input type="text" name="cvv" placeholder="CVV" maxlength="3"  class="form-control">
											  </div>
